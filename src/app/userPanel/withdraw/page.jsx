...
//                 pattern: {
//                   value: /^[0-9]{16}$/,
//                   message: "شماره شبا باید 16 رقم باشد و فقط شامل اعداد باشد",
//                 },
//               }}
//               render={({ field }) => (
//                 <input
...
const Withdraw = () => {
  ...
  // Trigger validation whenever the form changes
  useEffect(() => {
    trigger(); // Manually trigger validation on initial load
  }, [trigger]);
