...
//         <span className="text-yellow-500"> بیرگرم</span> چطور است؟
//       </h2>
...
//         صورت زیر می‌شود:
//       </p>
//       <div className="flex flex-row gap-4 mt-6 justify-around items-center">
//         <div className="bg-white shadow-md p-4 rounded-lg flex flex-col items-center justify-center">
//           <span className="text-sm text-center font-semibold">
//             ۶/۱۶۸/۲۰۰ تومان
//           </span>
...
//         {/* هزینه چاپ و بسته‌بندی */}
//         <div className="bg-white shadow-md p-4 rounded-lg flex flex-col items-center justify-center">
//           <span className="text-sm text-center font-semibold">۵۰/۰۰۰</span>
//         </div>
//         <div className="flex justify-center items-center">
//           <PlusIcon color="#000" />
//         </div>
...
//         <div className="bg-white shadow-md p-4 rounded-lg flex flex-col items-center justify-center">
//           <div className="flex items-center gap-2">
//             <span className="text-sm font-semibold">(۱/۰۰۵) * (۲/۸۲۰)</span>
//           </div>
//         </div>
...
//         {/* Right Box */}
//         <div className="bg-white shadow-md p-4 rounded-lg flex flex-col items-center justify-center">
//           <span className="text-sm text-center font-semibold">2000</span>
//         </div>
//       </div>

//       <div className="bg-[#EEF3FF] p-4 rounded-2xl flex items-center">
//         <div className="flex items-center justify-center w-6 h-6 bg-white rounded-full shadow-md m-2">
//           <svg
...
//           </svg>
//         </div>
//         <span className="text-blue-700 text-sm font-semibold flex-1 text-right">
